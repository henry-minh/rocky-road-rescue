...
const volunteerTypeCheckbox = {
  ...
  options: [
    ...
    { id: "volunteer-type-baking", text: "Baking for events & fundraisers" },
    { id: "volunteer-type-driving-dogs", text: "Driving (Dogs) – e.g. Transporting dogs to and from the vet; taking dogs to and from adoption events" },
    { id: "volunteer-type-driving-supplies", text: "Driving (Supplies) – e.g. Donation pick up and drop off; taking items to foster families etc." },
    { id: "volunteer-type-dog-sitting", text: "Dog sitting when foster families go out of town (usually a few days at a time)" },
    { id: "volunteer-type-oranize-events", text: "Helping organize and run fundraisers - eg. Bottle drives, online auctions, bake sales etc." },
    { id: "volunteer-type-photography", text: "Photography (please state skill level in ‘other’ section below)" },
        ...
        <form>
          ...
          <div>
            ...
            <div className="border-b border-gray-900/10 pb-5">
              ...
              <FormCheckbox title={bestContactCheckbox.title} options={bestContactCheckbox.options}></FormCheckbox>
            </div>
