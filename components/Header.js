...
const adopt = [
  {
    ...
    description: "Everything you need to know when adopting with Rocky Road Rescue",
...
const foster = [
  {
    name: "Why Foster",
    description: "Fostering a dog means you get to help give a dog a second chance at life.",
    href: "#",
    ...
    <header className="h-[88px]  w-full">
      <nav className="mx-auto flex gap-4 items-center py-2 lg:px-8 bg-zinc-900" aria-label="Global">
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-4 ">
          <a href="https://www.facebook.com/RockyRoadRescueCanada/events?ref=page_internal" target="_none" className="text-[#fff] text-lg leading-6 font-semi-bold group  transition duration-300   ">
            Events
          ...
          <a href="#" className="text-[#fff] text-lg leading-6 font-semi-bold group  transition duration-300">
            Pet Resources
            <span className="block max-w-0 group-hover:max-w-full transition-all duration-500 h-0.5 bg-white"></span>
          </a>
          <a href="#" className="text-[#fff] text-lg leading-6 font-semi-bold group  transition duration-300">
