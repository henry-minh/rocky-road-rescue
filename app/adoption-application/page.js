    ...
    return (
        <div>
            <div className="text-center">
                <p>
                    Please complete our Volunteer Application below and someone
                    from our Events & Fundraising Team will be in touch shortly.
                </p>
                <p>
                    If you have any questions about volunteering, please email
                    us at events@rockyroadrescue.com.
                </p>
                <p>
                    Click here to see what positions we currently have
                    available.
                </p>
                <p>We look forward to hearing from you soon!</p>
            </div>
            <div className="mx-auto w-11/12 rounded-lg bg-white px-2 py-1 shadow-xl sm:w-10/12 md:w-1/2">
                <form>
                    ...
                    <div className="space-y-12">
                        <div className="border-b border-gray-900/10 pb-12">
                            ...
                            <p className="mt-1 text-sm leading-6 text-gray-600">
                                Here at Rocky Road Rescue we are always looking
                                to expand our volunteer team and hear new and
                                innovative ideas. If you are keen to get
                                involved, we&quot;d love to have you on board!
                            </p>
